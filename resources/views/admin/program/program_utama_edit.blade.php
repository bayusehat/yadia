<section>
    <div class="card">
        ...
        <div class="card-body">
            ...
            @endif
            <form action="{{ url('admin/progutama/update/'.$progutama->programUtamaId) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xl-12">
                        <div class="form-group">
                            <label for="programUtamaTitle">Judul Program Utama</label>
                            <input type="text" class="form-control" name="programUtamaTitle" id="programUtamaTitle" value="{{ $progutama->programUtamaTitle }}">
                        ...
                        <div class="form-group"> 
                            ...
                            <textarea name="programUtamaContent" id="konten" cols="30" rows="10">{{ $progutama->programUtamaContent }}</textarea>
                        </div>
                    </div>
                </div>
                <div class="row">
