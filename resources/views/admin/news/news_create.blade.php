                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xl-12">
                        ...
                        <div class="form-group">
                            ...
                            <select name="newsCategoryId" id="newsCategoryId" class="form-control select2">
                                ...
                                @foreach ($newsCategory as $nc)
                                    <option value="{{ $nc->newsCategoryId }}">{{ $nc->newsCategoryName }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select name="newsTag[]" class="form-control tags" id="newsTag" multiple></select>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="newsContent" id="konten" cols="30" rows="10"></textarea>
                        </div>
                    </div>
                </div>
                <div class="row">
