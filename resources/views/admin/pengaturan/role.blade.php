        ...
        <hr>
            <div class="row">
                <div class="col-md-8 col-sm-12 col-xl-8">
                    <input type="text" class="form-control" name="roleName" id="roleName" placeholder="Nama Role">
...
<script>
    ...
    function loadData(){
        $('#tableData').DataTable({
            ...
            columns: [
                { name: 'roleId', searchable: false, orderable: true, className: 'text-center' },
                { name: 'roleName' },
    ...
    function show(id){
        ...
        $.ajax({
            ...
            success:function(res){
                ...
                $('#update').attr('onclick','ubah('+res.roleId+')');
            }
        })
    }
